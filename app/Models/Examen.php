...
class Examen extends Model
{
    ...
    protected $fillable = ['id','solicitud_id','num_examen','paciente_id','descripcion','estado','ci','fecha_resultado','resultado_estado', 'resultado_user','creatoruser_id','updateduser_id'];
