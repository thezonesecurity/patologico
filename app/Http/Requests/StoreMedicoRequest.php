...
class StoreMedicoRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'ci' => 'required|unique:App\Models\Medicos,ci|regex:/^[A-ZÑ0-9\s]+$/|min:5|max:15',
            'fecha_nacimiento' => 'required|date',
            'edad' => 'required|integer',
            'direccion' => 'nullable|regex:/^[a-zA-ZñÑ0-9\s.\/]+$/|max:200',
            'num_celular' => 'nullable|integer',
            'email' => 'nullable|unique:App\Models\Medicos,email|max:150',
            'especialidad' => 'required|regex:/^[a-zA-ZñÑ\s]+$/|min:2|max:200',
