...
<body>
    ...
    <table style="width: 100%; border-top: 2px solid black;">
        ...
        <tr>      
            <th class="text-center" style="margin-top: 0;">Resultado Informe Patológico - 
                @if($examenes->examen_solicitudes->tipo_solicitud === 'U')
                    Urbano
                @else
                    Rural
                @endif
    ...
    <!--<div style="text-align: center;">
        ...
        <table class="table table-striped numsolicitud">
            <thead class="cabecera">                    
                ...
                <th class="cabfsol2" style="text-align:center">{{$examenes->examen_solicitudes->fecha_solicitud}}</th>
                <th class="cabnex" style="text-align:left">Nº Examen:</th>
                <th class="cabnex2" style="text-align:center">{{$examenes->num_examen}}-{{$examenes->examen_solicitudes->tipo_solicitud}}</th>
        ...
        <table class="table table-striped">
            <thead class="cabecera">                    
                ...
                <th class="cabregional2" style="text-align:center">{{$examenes->examen_solicitudes->solicitud_municipios->nombre_municipio}}</th>                                          
                <th class="cabestablecimiento" style="text-align:left">Establecimiento:</th>
                <th class="cabestablecimiento2" style="text-align:center" colspan="3">{{$examenes->examen_solicitudes->solicitud_establecimientos->nombre_establecimiento}}</th>          
            </thead>  
        </table>
        ...
        <table class="table table-striped numsolicitud">      
            ...
            <tr>
                <td style="text-align: left">{{$examenes->examenPacientes->ci}}</td>
                <td style="text-align: left">{{$examenes->examenPacientes->nombre}}</td>
                <td style="text-align: left">{{$examenes->examenPacientes->apellido}}</td>
                <td style="text-align: left">{{$examenes->examenPacientes->edad}}</td>
            </tr>  
        </table>
